...
# Example usage:
# extract_frames("path_to_your_video.mp4", "output_frames", frame_rate=10)
...
#Additionally, you can use more control over the feature detection and matching process if the default stitching method does not yield satisfactory results. 
#Here's how you can manually handle the stitching process using key points and homography:
