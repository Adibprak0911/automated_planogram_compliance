...
#include "px4/msg/detail/buffer128__rosidl_typesupport_fastrtps_c.h"
...
using _Buffer128__ros_msg_type = px4__msg__Buffer128;
...
size_t get_serialized_size_px4__msg__Buffer128(
  const void * untyped_ros_message,
...
static uint32_t _Buffer128__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_px4__msg__Buffer128(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4
size_t max_serialized_size_px4__msg__Buffer128(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4__msg__Buffer128;
    is_plain =
      (
...
static size_t _Buffer128__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_px4__msg__Buffer128(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4, msg, Buffer128)() {
