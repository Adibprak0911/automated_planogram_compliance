...
#include "px4/msg/detail/differential_drive_setpoint__rosidl_typesupport_fastrtps_c.h"
...
#include "px4/msg/detail/differential_drive_setpoint__struct.h"
#include "px4/msg/detail/differential_drive_setpoint__functions.h"
...
using _DifferentialDriveSetpoint__ros_msg_type = px4__msg__DifferentialDriveSetpoint;
...
size_t get_serialized_size_px4__msg__DifferentialDriveSetpoint(
  const void * untyped_ros_message,
...
static uint32_t _DifferentialDriveSetpoint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_px4__msg__DifferentialDriveSetpoint(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4
size_t max_serialized_size_px4__msg__DifferentialDriveSetpoint(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4__msg__DifferentialDriveSetpoint;
    is_plain =
      (
...
static size_t _DifferentialDriveSetpoint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_px4__msg__DifferentialDriveSetpoint(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4, msg, DifferentialDriveSetpoint)() {
