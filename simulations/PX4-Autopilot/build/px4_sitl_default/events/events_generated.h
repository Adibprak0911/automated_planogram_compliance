...
enum class failsafe_action_t : uint8_t {
	...
	fallback_posctrl = 2, ///< Position mode
	fallback_altctrl = 3, ///< Altitude mode
	fallback_stabilized = 4, ///< Stabilized mode
	hold = 5, ///< Hold
	rtl = 6, ///< RTL
	land = 7, ///< Land
	descend = 8, ///< Descend
...
enum class failsafe_cause_t : uint8_t {
	...
	low_remaining_flight_time = 6, ///< Remaining flight time low
...
enum class health_component_t : uint32_t {
	...
	open_drone_id = 1073741824, ///< Open Drone ID system
...
enum class navigation_mode_group_t : uint32_t {
	...
	external8 = 1073741824, ///< External 8
	takeoff = 131072, ///< Takeoff
	external5 = 134217728, ///< External 5
	loiter = 16, ///< Loiter
	offboard = 16384, ///< Offboard
	external2 = 16777216, ///< External 2
	altctl = 2, ///< Altitude mode
	orbit = 2097152, ///< Orbit
	land = 262144, ///< Land
	external6 = 268435456, ///< External 6
	rtl = 32, ///< RTL
	stab = 32768, ///< Stabilized
	external3 = 33554432, ///< External 3
	posctl = 4, ///< Position mode
	vtol_takeoff = 4194304, ///< VTOL Takeoff
	follow_target = 524288, ///< Follow Target
	external7 = 536870912, ///< External 7
	external4 = 67108864, ///< External 4
	mission = 8, ///< Mission mode
	external1 = 8388608, ///< External 1
...
enum class navigation_mode_t : uint8_t {
	...
	external1 = 16, ///< External 1
	external2 = 17, ///< External 2
	external3 = 18, ///< External 3
	external4 = 19, ///< External 4
	posctl = 2, ///< Position control
	external5 = 20, ///< External 5
