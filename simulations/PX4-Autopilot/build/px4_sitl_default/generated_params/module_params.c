 ...
 * @unit m
 */
PARAM_DEFINE_FLOAT(RDD_WHEEL_BASE, 0.5);
 ...
 * @unit m
 */
PARAM_DEFINE_FLOAT(RDD_WHEEL_RADIUS, 0.1);
 ...
 * @max 1
 */
PARAM_DEFINE_FLOAT(RDD_SPEED_SCALE, 1);
 ...
 * @max 1
 */
PARAM_DEFINE_FLOAT(RDD_ANG_SCALE, 1);
 ...
 * @unit rad/s
 */
PARAM_DEFINE_FLOAT(RDD_WHEEL_SPEED, 0.3);
 ...
 * @max 100
 */
PARAM_DEFINE_FLOAT(RDD_P_HEADING, 1);
 ...
 * @max 100
 */
PARAM_DEFINE_FLOAT(RDD_P_SPEED, 1);
 ...
 * @max 100
 */
PARAM_DEFINE_FLOAT(RDD_I_SPEED, 0);
 ...
 * @max 100
 */
PARAM_DEFINE_FLOAT(RDD_P_ANG_VEL, 1);
 ...
 * @max 100
 */
PARAM_DEFINE_FLOAT(RDD_I_ANG_VEL, 0);
 ...
 * @unit m/s^3
 */
PARAM_DEFINE_FLOAT(RDD_MAX_JERK, 0.5);
 ...
 * @unit m/s^2
 */
PARAM_DEFINE_FLOAT(RDD_MAX_ACCEL, 0.5);
 ...
 * @max 100
 */
PARAM_DEFINE_FLOAT(RA_LOOKAHD_GAIN, 1);
 ...
 * @unit m
 */
PARAM_DEFINE_FLOAT(RA_LOOKAHD_MAX, 10);
 ...
 * @unit m
 */
PARAM_DEFINE_FLOAT(RA_LOOKAHD_MIN, 1);
