...
static constexpr param_info_s parameters[] = {
	...
	{
		.name = "RA_MAX_STR_RATE",
		.val = { .f = -1 },
	},

	{
		.name = "RA_MISS_VEL_DEF",
		.val = { .f = 2 },
	},

	{
		.name = "RA_MISS_VEL_GAIN",
		.val = { .f = 5 },
	},

	{
		.name = "RA_MISS_VEL_MIN",
		.val = { .f = 1 },
	},
	...
	{
		.name = "RDD_WHEEL_RADIUS",
		.val = { .f = 0.1 },
	},

	{
		.name = "RDD_WHEEL_SPEED",
		.val = { .f = 0.3 },
	},
	...
	{
		.name = "SIM_GZ_WH_FAIL1",
		.val = { .i = -1},
	},

	{
		.name = "SIM_GZ_WH_FAIL2",
		.val = { .i = -1},
	},

	{
		.name = "SIM_GZ_WH_FUNC1",
		.val = { .i = 0},
	},

	{
		.name = "SIM_GZ_WH_FUNC2",
		.val = { .i = 0},
	},
